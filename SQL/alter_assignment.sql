...
describe products;
insert into products (product_name, price) value ("Lemon Body Wash", 250);
...
alter table departments modify column department_name varchar(50) not null;
...
alter table job_history add constraint foreign key (employee_id)
...
insert into employees values (101, "Alice", "Brown", 20000, 22, 9, "active");
select * from employees;

set foreign_key_checks = 1; 
insert into employees values (102, "Brad", "Pitt", 80000, 40, 2, "inactive");

alter table employees drop constraint fk_department;
alter table employees modify column age smallint null;
describe employees;
insert into employees values (103, "Charles", "Babbage", 50000, null, 12, "inactive");
select * from employees;
